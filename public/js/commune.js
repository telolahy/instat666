...
function notify(from, align, icon, type, animIn, animOut, message){
    ...
    $(document).on('click', '#ajout_commune', function(e) {
        e.preventDefault();
        var data = {
    ...
    $(document).on('click','a.affiche_modal_commune',function(e){
        e.preventDefault();
        $commune_id = $(this).attr('id');
        $('#modal_commune').modal('show');  
         $('#value_commune').val($commune_id);
     });

     $(document).on('click','#supprimer_commune',function(){
         $commune_id = $('#value_commune').val();
         ...
         $.ajax({
            type: "DELETE",
            url : "/supprimer_commune/"+$commune_id,
            success : function (response) {
                $('#modal_commune').modal('hide');
                 $('tr#'+$commune_id).remove();
     ...
     $(document).on('click', '#modifier_commune', function(e) {
        e.preventDefault();
        var data = {
            'id': $('#id').val(),
            'code_commune': $('#code_commune').val(),
