...
class ReenregistrementSaisieController extends Controller
{
    /** 
    ...
    public function index()
    {
        ...
        // dd($etablissements);
        return view('saisisseur.enregistrement.index')->with('etablissements', $etablissements);
    }
    ...
    public function edit($id)
    {
        ...
        return view('saisisseur.enregistrement.edit')
