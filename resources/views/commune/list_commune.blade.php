        ...
        <div class="card-block p-0">
            <div class="tab-content card-block">
                <div class="header" style="padding-bottom: 3%">
                    <h4 class="title" style="text-align: center">Liste des commune</h4>
                </div>
                            ...
                            <tbody>
                                @foreach ($communes as $commune)
                                    <tr class="table" id={{$commune->id}}>
                                        ...
                                        <td>{{$commune->district}}</td>
                                        <td>{{$commune->region}}</td>
                                        <td>
                                            <a onclick="window.location='{{url('/form_edit_commune/'.$commune->id)}}'" data-toggle="tooltip" title="Modifier" class="modifier" id=""><h6><i class="ti ti-pencil-alt" style="color: #1e7e34"></i></h6></a><br/>
                                            <a data-toggle="tooltip" title="Supprimer" class="affiche_modal_commune" id={{$commune->id}}><h6><i class="ti ti-trash" style="color: #f50909"></i></h6></a>
                                        </td>
                                     </tr>  
