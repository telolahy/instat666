                ...
                <div class="card tabs-card">
                    <div class="card-block p-0">
                      ...
                      <div class="header" style="padding-bottom: 3%">
                          ...
                          {!! Form::open(['action' => 'App\Http\Controllers\UserController@ajout_user', 'method' => 'POST', 'enctype'=> 'multipart/form-data', 'id'  => 'userForm' ]) !!}
                              {{ csrf_field() }}
                              ...
                              <div class="form-group row">
                                  ...
                                  <div class="col-sm-10">
                                      <input type="text" class="form-control form-control-bold form-control-center" placeholder="Nom" name="name" id="name">
                                  </div>
                              </div>
                              <div class="form-group row">
                                  <label class="col-sm-2 col-form-label">Email : <span style="color: red">*</span></label>
                                  <div class="col-sm-10">
                                      <input type="text" class="form-control form-control-bold form-control-center" placeholder="Email" name="email" id="email">
                                  </div>
                              </div>
                              <div class="form-group row">
                                  <label class="col-sm-2 col-form-label">Region : <span style="color: red">*</span></label>
                                  <div class="col-sm-10">
                                        <select class="form-control" required name="region_user" id="region_user"  >
                              ...
                              <div class="form-group row">
                                  ...
                                  <div class="col-sm-10">
                                      <input type="password" class="form-control form-control-bold form-control-center" placeholder="Mot de passe" name="password" id="password">
                                  </div>
                              </div>
                              <div class="form-group row">
                                  <label class="col-sm-2 col-form-label"> Confirmation du Mot de passe : <span style="color: red">*</span></label>
                                  <div class="col-sm-10">
                                      <input type="password" class="form-control form-control-bold form-control-center" placeholder="Confirmer le mot de passe" name="password2" id="password2">
                                  </div>
                              </div>
