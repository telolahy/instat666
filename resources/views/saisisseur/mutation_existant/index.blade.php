                            ...
                            <tbody>
                                @foreach ($etablissements as $etablissement)
                                    <tr class="table" id={{$etablissement->id}}>
                                        ...
                                        <td>
                                            <a onclick="window.location='{{route('mutation_existant.edit',$etablissement->id)}}'" data-toggle="tooltip" title="Modifier cet établissement" class="modifier btn btn-outline-primary rounded-circle" id="">Mutation</a><br/>
                                        </td>
                                     </tr>  
                                @endforeach  
                            </tbody>
