    ...
    <div class="card tabs-card">
        <div class="card-block p-0">
            <div class="tab-content card-block">
                ...
                <label strong class="col-sm-3 col-form-label"><strong>Numéro CIN : </strong></label> {{$etablissement->proprietaire->cin}}<br/>
                <label strong class="col-sm-3 col-form-label"><strong>Nom du propriétaire : </strong></label> {{$etablissement->proprietaire->nom}}<br/>
                <label strong class="col-sm-3 col-form-label"><strong>Adresse : </strong></label> {{$etablissement->proprietaire->adresse}} <label class="col-sm-1 col-form-label"><strong> à   :</strong></label> {{$etablissement->proprietaire->fokontany->fokotany}} <br/>
                <label strong class="col-sm-3 col-form-label"><strong>Commune : </strong></label> {{$etablissement->proprietaire->commune->commune}} <label class="col-sm-2 col-form-label"> <strong> District :</strong></label> {{$etablissement->proprietaire->commune->district}} <br/>
                <label strong class="col-sm-3 col-form-label"><strong>Région : </strong></label> {{$etablissement->proprietaire->commune->region}}<br/>
                <label strong class="col-sm-3 col-form-label"><strong>Nationalité : </strong></label> {{$etablissement->proprietaire->nationalite->nationalite}}<br/>
                <label strong class="col-sm-3 col-form-label"><strong>Numéro téléphone : </strong></label> {{$etablissement->proprietaire->num_tel}}<br/><br/>
                <label strong class="col-sm-3 col-form-label"><strong>Lien : </strong></label> {{$etablissement->proprietaire->lien}}<br/>
