                    ...
                    <div class="card-block p-0">
                      ...
                      <div class="header" style="padding-bottom: 3%">
                          <h4 class="title" style="text-align: center">A propos du Propriétaire</h4><hr/>
                           ...
                           {!! Form::open(['action' => 'App\Http\Controllers\ProprietaireController@modifier_proprio_etablissement',  'method' => 'POST' , 'id' => 'proprietaireForm' ]) !!} 
                              ...
                              <div class="form-group row">
                                  ...
                                  <div class="col-sm-10">
                                      <input type="text" class="form-control form-control-bold form-control-center" placeholder="Nom complet " name="nom" id="nom" value="{{$etablissement->proprietaire->nom}}" readonly>
                                  </div>
                              </div>
                              <div class="form-group row">
                              ...
                              <div class="form-group row">
                                    <div class="col">
                                        ...
                                        <input type="number" class="form-control form-control-bold form-control-center" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" maxlength = "10" name="num_tel"  id="num_tel" value="{{$etablissement->proprietaire->num_tel}}"/>
                                    </div>
                                    <div class="col-sm-4">
                                        <label class="">Lien : <span style="color: red">*</span></label>
                                        <input type="number" class="form-control form-control-bold form-control-center" placeholder="lien" name="lien" id="lien" value="{{$etablissement->proprietaire->lien}}" readonly>
                                    </div>
                                    <div class="col">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control form-control-bold form-control-center" value="{{$etablissement->sigle}}" name="sigle" id="sigle">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-sm-2 col-form-label">Adresse : <span style="color: red">*</span></label>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <label class=""></label>
                                    <input type="number" class="form-control form-control-bold form-control-center" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" maxlength = "25" name="fond"  id="fond" placeholder="Fond" value="{{$etablissement->fond}}"/>
                                </div>
                            </div>
                            <div class="form-group row">
                                <div class="col-sm-2">
                                ...
                                <div class="col">
                                    ...
                                    <input type="number" class="form-control form-control-bold form-control-center" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" maxlength = "10" name="tel_etab"  id="tel_etab" placeholder="Téléphone établissement" value="{{$etablissement->tel_etab}}"/>
                                </div>
                                <div class="col-sm-4">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-5">
                                    ...
                                    <input type="text" class="form-control form-control-bold form-control-center"  name="district_etab" id="district_etab" value="{{$etablissement->commune->district}}"  readonly>
                                </div>
                                <div class="col-sm-5">
                                    <label class="">Région :</label>
                                    <input type="text" class="form-control form-control-bold form-control-center"  name="region_etab" id="region_etab" value="{{$etablissement->commune->region}}" readonly>
                                </div>
                            </div>
                            <div class="form-group row">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col">
                                    <label class=""></label>
                                    <input type="number" class="form-control form-control-bold form-control-center" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" maxlength = "5" name="malagasy_m"  id="malagasy_m" value="{{$etablissement->malagasy_m}}"/>
                                </div>
                                <div class="col-sm-4">
                                    <label class=""></label>
                                    <input type="number" class="form-control form-control-bold form-control-center" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" maxlength = "5" name="malagasy_f"  id="malagasy_f" value="{{$etablissement->malagasy_f}}"/>
                                </div>
                            </div>
                            <div class="form-group row">
                                <div class="col-sm-2">
                                ...
                                <div class="col">
                                    <input type="number" class="form-control form-control-bold form-control-center" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" maxlength = "5" name="etranger_m"  id="etranger_m" value="{{$etablissement->etranger_m}}" />
                                </div>
                                <div class="col-sm-4">
                                    <input type="number" class="form-control form-control-bold form-control-center" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" maxlength = "5" name="etranger_f"  id="etranger_f" value="{{$etablissement->etranger_f}}" />
                                </div>
                            </div><br/>
                            <hr/>
                              <div class="header" style="padding-bottom: 3%">
                                    <h4 class="title" style="text-align: center">Droit de Modification </h4><hr/>
                              </div>
                            <div class="form-group row" hidden>
                              ...
                              <div class="form-group row">
                                  ...
                                  <div class="col-sm-10">
                                      <input type="text" class="form-control form-control-bold form-control-center" placeholder="Numero du quitance" name="num_quitance" id="num_quitance">
                                  </div>
                              </div>
                              <div class="form-group row">
                              ...
                              <div class="form-group row">
                                  ...
                                  <div class="col-sm-10" >
                                      {{Form::submit('Envoyer', ['class' => 'btn btn-outline-primary', 'id' => 'edit_proprietaire'])}} 
                                  </div>
                              </div>
                          {!! Form::close() !!}
