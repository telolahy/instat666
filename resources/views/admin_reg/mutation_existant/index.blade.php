                            ...
                            <tbody>
                                @foreach ($etablissements as $etablissement)
                                    <tr class="table" id={{$etablissement->id}}>
                                        ...
                                        <td>
                                          @foreach ($etablissement->proprietaires as $proprietaire)
                                            {{ $proprietaire->cin }}
                                            @break                                        
                                          @endforeach
                                        </td>
                                        ...
                                        <td>
                                            <a onclick="window.location='{{route('admin_reg_mutation_existant.edit',$etablissement->id)}}'" data-toggle="tooltip" title="Modifier cet établissement" class="modifier btn btn-outline-primary rounded-circle" id="">Mutation</a><br/>
                                        </td>
                                     </tr>  
                                @endforeach  
                            </tbody>
