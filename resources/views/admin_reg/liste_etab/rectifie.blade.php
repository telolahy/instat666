                ...
                <div class="card tabs-card">
                    <div class="card-block p-0">
                      ...
                      <div class="header" style="padding-bottom: 3%">
                        ...
                        <form action="{{route('reg_etab.rectifie',$etablissement->id)}}" method="POST" >
                           @csrf 
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-4">
                                ...
                                <div class="col-sm-10" >
                                    ...
                                    <!-- <a onclick="window.location='{{ route('reg_etab.rectifie', $etablissement->id) }}'" class="btn btn-inverse btn-outline-inverse" style="display: inline;margin-left: 60%"><i class="icofont icofont-info-square"></i> Retour </a> -->
                                </div>
                        </form>
