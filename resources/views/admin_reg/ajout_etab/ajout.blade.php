                        ...
                        <!--table style="margin-bottom: 50px;
                            ...
                            <div class="form-group row">
                              ...
                              <div class="form-group row">
                                  ...
                                  <div class="col-sm-10">
                                      <input type="text" class="form-control form-control-bold form-control-center" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" maxlength = "12" name="cin"  id="cin" value="{{ old('cin') }}" placeholder="CIN"/>
                                  </div>
                              </div>
                              <div class="form-group row">
                                  <label class="col-sm-2 col-form-label" >Nom Complet : <span style="color: red">*</span></label>
                                  <div class="col-sm-10">
                                      <input type="text" class="form-control form-control-bold form-control-center" placeholder="Nom complet " name="nom" value="{{ old('nom') }}" id="nom"  onkeyup="this.value = this.value.toUpperCase();">
                                  </div>
                              </div>
                              <div class="form-group row">
                              ...
                              <div class="form-group row">
                                  ...
                                  <div class="col-sm-10">
                                    <input type="text" class="form-control form-control-bold form-control-center" placeholder="Adresse " name="adresse" value="{{ old('adresse') }}" id="adresse"  onkeyup="this.value = this.value.toUpperCase();">
                                </div>
                              </div>
                              <div class="form-group row">
                              ...
                              <div class="form-group row">
                                    <div class="col">
                                        ...
                                        <input type="text" class="form-control form-control-bold form-control-center" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" maxlength = "10" name="num_tel" value="{{ old('num_tel') }}" id="num_tel" placeholder="Numero téléphone"/>
                                    </div>
                                    <div class="col-sm-4">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control form-control-bold form-control-center" onkeyup="this.value = this.value.toUpperCase();" placeholder="Sigle" name="sigle" value="{{ old('sigle') }}" id="sigle">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-sm-2 col-form-label">Adresse : <span style="color: red">*</span></label>
                                <div class="col-sm-10">
                                    <input onkeyup="this.value = this.value.toUpperCase();" type="text" class="form-control form-control-bold form-control-center" placeholder="Adresse de l'etablissement" name="adresse_etab" value="{{ old('adresse_etab') }}" id="adresse_etab">
                                </div>
                            </div>
...
<br>
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text"  onkeyup="this.value = this.value.toUpperCase();" class="form-control form-control-bold form-control-center" placeholder="Activité secondaire 1 " name="activite_1" id="activite_1">
                                </div>
                            </div>
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" onkeyup="this.value = this.value.toUpperCase();" class="form-control form-control-bold form-control-center" placeholder="Activité secondaire 2 " name="activite_2" id="activite_2">
                                </div>
                            </div>
