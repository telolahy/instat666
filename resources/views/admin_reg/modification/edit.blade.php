            ...
            <div class="tab-content card-block">
                ...
                <form action="{{route('reg_modification.update',$etablissement->id)}}" method="POST" id="proprietaireForm">
                    ...
                    <input type="hidden"
                        ...
                        value="{{$etablissement->proprietaires->first()->id}}" readonly>
                    <input type="hidden"
                        class="form-control form-control-bold form-control-center"
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input type="number"
                                ...
                                value="{{$etablissement->proprietaires->first()->cin}}"
                                readonly />
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input type="text"
                                ...
                                value="{{$etablissement->proprietaires->first()->nom}}"
                                readonly>
                        </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input type="text"
                                ...
                                id="adresse"
                                value="{{$etablissement->proprietaires->first()->adresse}}">
                        </div>
                    </div>
                    <div class="form-group row">
                    ...
                    <div class="form-group row">
                        <div class="col">
                            ...
                            <input type="number"
                                ...
                                value="{{$etablissement->proprietaires->first()->num_tel}}" />
                        </div>
                        <div class="col-sm-4">
                            ...
                            <input type="number"
                                ...
                                value="{{$etablissement->proprietaires->first()->lien}}"
                                readonly>
                        </div>
                        <div class="col">
                            ...
                            <input type="email"
                                ...
                                value="{{$etablissement->proprietaires->first()->email}}">
                        </div>
                    </div>
                    <br /><hr />
                    <div class="header" style="padding-bottom: 3%">
