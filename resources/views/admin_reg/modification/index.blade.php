                            ...
                            <tbody>
                                @foreach ($etablissements as $etablissement)
                                    <tr class="table" id={{$etablissement->id}}>
                                        ...
                                        <td>
                                            <a onclick="window.location='{{route('reg_modification.edit',$etablissement->id)}}'" data-toggle="tooltip" title="Modifier cet établissement" class="modifier btn btn-outline-primary rounded-circle" id="">Modifier</a><br/>
                                        </td>
                                     </tr>  
                                @endforeach  
                            </tbody>
